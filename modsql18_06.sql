...
CREATE TABLE `feedback` (
  ...
  `ExtraFeedback` varchar(50) NOT NULL,
  `Location` varchar(20) NOT NULL,
  `Phone_no.` varchar(10) NOT NULL,
  `ManagementOfEvent` varchar(10) NOT NULL,
  `CoordinatorReview` varchar(10) NOT NULL,
...
INSERT INTO `feedback` VALUES ('prathamesh patil','Very great institute.Also the Events are good, but','Mumbai','9634201563','','',''),('Ritesh','Nice ','Mumbai','','','','');
...
INSERT INTO `feedback_comp` VALUES ('mayur','Average Event.','Panvel','876091648','','',''),('avinash','nice,good oranised.','kalyan','7865094876','','',''),('Tanvir','VERY NICE COMPUTER DEPARTMENT','MUMBAI','8970654786','','',''),('Ani','Great','Pune','htey890','','',''),('gfg','fg','fg','fr45','','',''),('Atharva','','Mumbai','7865098767','Good','Very Good','Sports');
/*!40000 ALTER TABLE `feedback_comp` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `feedback_comp_event_additional`
--

DROP TABLE IF EXISTS `feedback_comp_event_additional`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `feedback_comp_event_additional` (
  `Name` varchar(20) NOT NULL,
...
--
-- Dumping data for table `feedback_comp_event_additional`
--

LOCK TABLES `feedback_comp_event_additional` WRITE;
/*!40000 ALTER TABLE `feedback_comp_event_additional` DISABLE KEYS */;
/*!40000 ALTER TABLE `feedback_comp_event_additional` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `feedback_comp_sports` VALUES ('alpesh','great....','thane','8956473201','','',''),('Prathamesh','Nice','Mumbai','8765409768','','','');
...
--
-- Table structure for table `feedback_comp_trial`
--

DROP TABLE IF EXISTS `feedback_comp_trial`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `feedback_comp_trial` (
  `Name` varchar(20) NOT NULL,
  `Feedback` varchar(50) NOT NULL,
  `Location` varchar(50) NOT NULL,
  `Phone_no.` varchar(10) NOT NULL
...
--
-- Dumping data for table `feedback_comp_trial`
--

LOCK TABLES `feedback_comp_trial` WRITE;
/*!40000 ALTER TABLE `feedback_comp_trial` DISABLE KEYS */;
/*!40000 ALTER TABLE `feedback_comp_trial` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `feedback_mechanical` VALUES ('Atharva','Nice to see.','Vashi','8574635241','','',''),('Anil','Great','Thane','7u6849932','','','');
...
--
-- Table structure for table `feedback_nss_addevent`
--

DROP TABLE IF EXISTS `feedback_nss_addevent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `feedback_nss_addevent` (
  `Name` varchar(20) NOT NULL,
  `Feedback` varchar(50) NOT NULL,
  `Location` varchar(50) NOT NULL,
  `Phone_no.` varchar(10) NOT NULL
...
--
-- Dumping data for table `feedback_nss_addevent`
--

LOCK TABLES `feedback_nss_addevent` WRITE;
/*!40000 ALTER TABLE `feedback_nss_addevent` DISABLE KEYS */;
/*!40000 ALTER TABLE `feedback_nss_addevent` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-06-18 16:27:25
